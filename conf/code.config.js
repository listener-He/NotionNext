...
module.exports = {
  // START********代码相关********
  // PrismJs 代码相关
  PRISM_JS_PATH: process.env.NEXT_PUBLIC_PRISM_JS_PATH || 'https://npm.elemecdn.com/prismjs@1.29.0/components/',
  PRISM_JS_AUTO_LOADER:
    process.env.NEXT_PUBLIC_PRISM_JS_AUTO_LOADER ||
  ...
  MERMAID_CDN:
    ...
    'https://cdnjs.cloudflare.com/ajax/libs/mermaid/11.9.0/mermaid.min.js' // CDN
