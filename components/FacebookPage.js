...
const FacebookPage = () => {
  ...
  return <div className="shadow-md hover:shadow-xl dark:text-indigo-200 border dark:border-black rounded-xl px-2 py-4 bg-white dark:bg-hexo-black-gray lg:duration-100 justify-center">
